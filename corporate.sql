...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 09 2017 г., 14:19
...
(1, 'Главная', 'http://c.hh', 0, NULL, NULL),
(3, 'Блог', 'http://c.hh/articles', 0, NULL, NULL),
(4, 'Компьютеры', 'http://c.hh/articles/cat/computers', 3, NULL, NULL),
(5, 'Интересное', 'http://c.hh/articles/cat/iteresting', 3, NULL, NULL),
(6, 'Советы', 'http://c.hh/articles/cat/soveti\n', 3, NULL, NULL),
(7, 'Портфолио', 'http://c.hh/portfolios\n', 0, NULL, NULL),
(8, 'Контакты', 'http://c.hh/contacts\n', 0, NULL, NULL);
...
(1, 'User', 'user@mail.ru', '$2y$10$WGH9LJAqL4Ma.9nrrb/mreS08IiCQXD8dzfCvv4qx.7T9bmOxmrtS', '8N6ikNE1o806YKGvRf6ILDqykxgrMV2h40SSg1YUnvuypIwK85RaFpKoTQKS', '2016-07-17 03:21:51', '2017-01-09 08:16:22', 'user'),
(3, 'user3', 'user3@mail.ru', '123456', NULL, '2016-08-18 12:50:19', '2016-08-18 12:50:19', 'user3'),
(4, 'user2', 'user2@mail.ru', '$2y$10$a.iN9ngVcyys97.sdjRSm.cZL0HUmL5nMy28yxlClxH977PYPKm.S', 'qhXknZbfzSpYi6o1ZN9W9VGM99O9myEdd6iiubgp2BnTgjFkHn8usn458D4l', '2016-12-09 13:04:06', '2016-12-17 14:01:20', 'user2');
